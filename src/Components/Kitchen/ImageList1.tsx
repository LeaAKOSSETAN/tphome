...
import ImageItem from './ImageItem1';
...
function ImageList() {
  const images = [
    ...
    },
    {
      ...
      url: 'https://websitedemos.net/blog-02/wp-content/uploads/sites/132/2017/08/pic08-free-img.jpg',
...

    {
        ...
        lien: 'November 20, 2017 / Living Room',
        url: 'https://websitedemos.net/blog-02/wp-content/uploads/sites/132/2017/06/pic09-free-img.jpg',
...

      {
        ...
        url: 'https://websitedemos.net/blog-02/wp-content/uploads/sites/132/2010/10/furnished-kitchen.jpg',
